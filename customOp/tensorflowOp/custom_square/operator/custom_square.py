...
def custom_square_compute(placeholders, shape, dtype, kernel_name="cce_custom_square",
                      need_build=False,
                      need_print=False):
    data = placeholders[0]
...
def custom_square(shape, dtype, kernel_name="cce_custom_square", need_build=False,
                  need_print=False):
    """
